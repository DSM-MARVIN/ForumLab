    ...
    >
      <div>
        <div class="flex items-center mb-20">
          ...
          <div>
            <p class="text-base font-bold text-gray-500">LogRocket</p>
        ...
        <div class="flex justify-between mb-8">
          <p class="flex items-center">
            <span class="text-base font-semibold">Filter Jobs</span>
            <svg
              width="10"
              height="7"
              viewBox="0 0 10 7"
        ...
        <ul>
          <li class="mb-5">
            <a class="flex items-center" href="/?search=Laravel">
          ...
          <li class="mb-5 flex justify-between items-center">
            <a class="flex items-center" href="/?search=Angular">
          ...
          <li class="mb-5 flex justify-between items-center">
            <a class="flex items-center" href="/?search=SQL">
          ...
          <li class="mb-5 flex justify-between items-center">
            <a class="flex items-center" href="/?search=Vue">
          ...
          <li class="mb-12">
            <a class="flex items-center" href="/?search=React">

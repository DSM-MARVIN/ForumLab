...
<head>
  ...
  <link rel="icon" href="images/3163810.png" />
...
<body class="mb-48">
  ...
  <header>
     <nav
          ...
          @auth
            <li>
              <!-- <a class="md:p-4 py-2 block hover:text-purple-400" href="#"
                >Features</a
              > -->
              <span class="md:p-4 py-2 block hover:text-purple-400">
          Welcome {{auth()->user()->name}}
        </span>
            </li>
            <li>
              <!-- <a class="md:p-4 py-2 block hover:text-purple-400" href="#"
                >Pricing</a
              > -->
              <a href="/listings/manage" class="md:p-4 py-2 block hover:text-purple-400"><i class="fa-solid fa-gear"></i> Manage Listings</a>
            </li>
            <li>
              <!-- <a class="md:p-4 py-2 block hover:text-purple-400" href="#"
                >Customers</a
              > -->
              <form class="md:p-4 py-2 block hover:text-purple-400" method="POST" action="/logout">
          @csrf
          <button type="submit">
            <i class="fa-solid fa-door-closed"></i> Logout
          </button>
      ...
      <li>
        <a href="/login" class="md:p-4 py-2 block hover:text-purple-400"> Login</a>
      </li>

      <li>
        <a href="/register" class="md:p-4 py-2 block hover:text-purple-400"> Register</a>
      </li>
      @endauth
            <!-- <li>
              <a
  ...
  <footer
    class="fixed bottom-0 left-0 w-full flex items-center justify-start font-bold bg-indigo text-white h-24 mt-24 opacity-90 md:justify-center">
    <!-- <p class="ml-2">Copyright &copy; 2022, All Rights reserved</p> -->

    <a href="/listings/create" class="absolute top-1/3 right-10 bg-green-600 w-10 h-10 text-white py-2 px-5 pr-7 rounded-2xl">+</a>
  </footer>

      ...
      <div>
        ...
        <div class="flex justify-between mb-8">
          <p class="flex items-center">
            <span class="text-base font-semibold">Post</span>
            <svg
              width="10"
              height="7"
              viewBox="0 0 10 7"
            ...
            >
              <path
                d="M0 -4.15258e-07L9.5 0L5 7L0 -4.15258e-07Z"
                fill="black"
              />
            </svg>
          </p>
        ...
        <ul>
          ...
          <li class="mb-5 flex justify-between items-center">
            <a class="flex items-center">
              ...
              <span class="text-base font-semibold text-zinc-500 ml-3"
                >Today's Scheduled</span
              >
            </a>
            <button class="border-1 text-zinc-500 rounded-full border-2 px-2">
              +2
            </button>
          </li>
          <li class="mb-12">
        ...
        <div class="flex justify-between mb-8">
          <p class="flex items-center">
            <span class="text-base font-semibold">Favorite Users</span>
            <svg
              width="7"
              height="10"
              viewBox="0 0 7 10"
...
<div id="container-floating" class="z-50">
  ...
  <div id="floating-button">
    ...
    <div class="mb-8 font-sans antialiased text-gray-900">
      ...
      <div
        class="flex mb-8 flex-col items-center md:mb-14 xl:flex-row xl:items-start xl:space-x-4"
      >
        <div class="w-full xl:w-2/3">
          ...
          <div class="p-4 bg-white rounded-xl shadow-md mb-4 xl:mb-10">
            ...
            >
              ...
              <path
                ...
                stroke="#DCE3EB"
                stroke-width="0.631372"
                stroke-linecap="round"
                stroke-dasharray="1.89 2.53"
              />
              <path
          ...
          >
            ...
            >
              ...
              <h3 class="text-[#393939] font-bold mb-1">
            ...
            <div class="w-full p-4 bg-white rounded-xl shadow-md md:w-1/4">
              ...
              <h3 class="text-[#393939] font-semibold text-center">
                Scheduled Post
              </h3>
            </div>
            <div class="w-full p-4 bg-white rounded-xl shadow-md md:w-1/4">
          ...
          <div class="w-full p-4 bg-white rounded-xl shadow-md">
            ...
            >
              ...
              <defs>
                ...
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop offset="0.0052011" stop-color="#D320C1" />
                  <stop offset="0.320198" stop-color="#C624C6" />
                  <stop offset="0.970779" stop-color="#1461FF" />
                </linearGradient>
                <linearGradient
                ...
                >
                  <stop offset="0.0052011" stop-color="#D320C1" />
                  <stop offset="0.498033" stop-color="#C624C6" />
                  <stop offset="0.970779" stop-color="#1461FF" />
                </linearGradient>
              </defs>
            </svg>
            <h3 class="text-sm font-bold mb-4 text-center text-[#242121]">
              Events DISTRIBUTION
            </h3>
            <div class="flex mb-4 justify-between">
              <div class="flex items-center">
                ...
                <p class="text-sm font-semibold text-[#242121] ml-4">Likes</p>
              </div>
              <div class="flex items-center">
                <svg
                  width="35"
                ...
                <p class="text-sm font-semibold text-[#242121] ml-4">Views</p>
              </div>
            </div>
            <div class="flex mb-4 justify-between">
              <div class="flex items-center">
                ...
                <p class="text-sm font-semibold text-[#242121] ml-4">Follows</p>
              </div>
              <div class="flex items-center">
                <svg
                  width="35"
                ...
                <p class="text-sm font-semibold text-[#242121] ml-4">Share</p>
              </div>
            </div>
          </div>
        </div>
      </div>
      <h2 class="text-base font-bold mb-4">Statistics</h2>
      <div
      ...
      >
        ...
        >
          <div>
            ...
            <p class="text-[#4D4A81] font-semibold">25% achieved</p>
          </div>
    ...
    <section class="hidden ml-5 px-5 py-9 xl:flex xl:flex-col xl:w-2/12">
      <div class="flex justify-between items-center mb-16">
        ...
        <div>
          ...
          <button
            class="border-2 border-gray-200 rounded-xl p-2.5 relative btn-shadow"
          >
            <svg
              width="24"
              height="24"

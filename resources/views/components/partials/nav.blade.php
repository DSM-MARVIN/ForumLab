    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 bg-search">
        <div class="flex items-center justify-between h-16 space-x-12 ">
            ...
            <div class="flex items-center flex-grow">
                ...
                <livewire:search /> 
                <span class='ml-10 logo'><span class='milkshake'>Milkshake</span>Lab.Net</span>
                <input type="search" name="search" id="search" class="w-full border-none rounded-r shadow-inner bg-blue-50 focus:ring-blue-200" placeholder="Search Topics">
            </div>
